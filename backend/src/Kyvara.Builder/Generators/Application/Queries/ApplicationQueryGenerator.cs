...
namespace Kyvara.Builder.Generators.Application.Queries;

/// <summary>
/// Generates an application query record.
/// </summary>
public sealed partial class ApplicationQueryGenerator
    : ApplicationGeneratorBase
{
    private const string TemplateName = "application/query.cs";

    private const string DefaultOutputPath = "Queries";
        ...
        DefaultTemplates =
                ...
                StringComparer.OrdinalIgnoreCase)
            {
                [TemplateName] =
                    ...
                    /// <summary>
                    /// Represents the {{QueryName}} application query.
                    /// </summary>
                    public sealed record {{QueryName}};
                    """
            };
    ...
    /// <summary>
    /// Creates the generator with its built-in query template.
    /// </summary>
    public ApplicationQueryGenerator()
    ...
    /// <inheritdoc />
    public override string Name => "application-query";
        ...
        CancellationToken cancellationToken)
    {
        ...
        var queryName = ValidateRequiredToken(
            context,
            "QueryName");
