...
/// <summary>
/// Generates an application command handler.
/// </summary>
public sealed partial class ApplicationCommandHandlerGenerator
    : ApplicationGeneratorBase
{
    private const string TemplateName =
        "application/command-handler.cs";
        ...
        DefaultTemplates =
                ...
                StringComparer.OrdinalIgnoreCase)
            {
                [TemplateName] =
                    ...
                    /// <summary>
                    /// Handles the {{CommandName}} command.
                    /// </summary>
                    public sealed class {{HandlerName}}
                    {
                        ...
                        /// </summary>
                        public Task<{{ResultName}}> HandleAsync(
                            {{CommandName}} command,
    ...
    /// <summary>
    /// Creates the generator with its built-in command-handler template.
    /// </summary>
    public ApplicationCommandHandlerGenerator()
        ...
        CancellationToken cancellationToken)
    {
        ...
        var resultName = ValidateRequiredToken(
            context,
            "ResultName");

        var handlerName = GetOptionalToken(
            context,
            "HandlerName",
            $"{commandName}Handler");
        ...
        CancellationToken cancellationToken)
    {
        ...
        var commandName = GetRequiredToken(
            context,
            "CommandName");

        var resultName = GetRequiredToken(
            context,
            "ResultName");
